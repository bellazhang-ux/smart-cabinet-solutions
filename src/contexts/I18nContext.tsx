...
const translations: Record<Lang, Record<string, string>> = {
  ...
  'zh-TW': {
    ...
    'pay.method': '付款方式',
    'pay.confirm': '確認付款',
    'pay.processing': '正在處理付款...',
    'pay.success': '付款成功！',
    'pay.failed': '付款失敗',
    'pay.retryHint': '請檢查付款資訊後重試',
    'pay.retry': '重試',
    'pay.close': '關閉',
    'pay.txId': '交易號',
    'pay.assignedSlot': '已分配櫃位',

    'approvals.duration': '使用時長',
    'approvals.dur.1hour': '1小時',
    'approvals.dur.1day': '1天',
    'approvals.dur.3days': '3天',
    'approvals.dur.1week': '1週',
    'approvals.submitted': '申請已提交',
    'approvals.autoUnlock': '已批准，櫃鎖已自動解鎖',
    'approvals.approvedUnlock': '已批准並自動解鎖櫃位',
    'approvals.approver': '審批人',
    'approvals.status.pending': '待審批',
    'approvals.status.approved': '已批准',
    'approvals.status.rejected': '已駁回',
    'approvals.pendingTab': '待審批',
    'approvals.historyTab': '審批歷史',
    'approvals.noPending': '暫無待審批請求',
    'approvals.noHistory': '暫無歷史紀錄',

    'dashboard.assignedSlots': '我的櫃位',
    'dashboard.lastAccess': '最後訪問',
    'dashboard.quickPurchase': '快捷購買',
    'dashboard.viewAll': '查看全部',
    'dashboard.myLogs': '我的操作紀錄',
  ...
  'en': {
    ...
    'pay.retryHint': 'Please check your payment info and try again',
    'pay.retry': 'Retry',
    'pay.close': 'Close',
    'pay.txId': 'Transaction ID',
    'pay.assignedSlot': 'Assigned Slot',

    'approvals.duration': 'Duration',
    'approvals.dur.1hour': '1 Hour',
    'approvals.dur.1day': '1 Day',
    'approvals.dur.3days': '3 Days',
    'approvals.dur.1week': '1 Week',
    'approvals.submitted': 'Request submitted',
    'approvals.autoUnlock': 'Approved — locker auto-unlocked',
    'approvals.approvedUnlock': 'Approved & locker unlocked',
    'approvals.approver': 'Approved by',
    ...
    'approvals.noHistory': 'No history yet',

    'dashboard.assignedSlots': 'Assigned Slots',
    'dashboard.lastAccess': 'Last access',
    'dashboard.quickPurchase': 'Quick Purchase',
    'dashboard.viewAll': 'View All',
    'dashboard.myLogs': 'My Activity',
